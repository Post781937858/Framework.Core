...
namespace Framework.Core.Common
{
    public class RedisCacheManager : ICache
    {
        ...
        {
            string redisConfiguration = Appsettings.app(new string[] { "AppSettings", "Redis", "ConnectionString" });//获取连接字符串
        ...
        public TEntity Get<TEntity>(string key)
        {
            ...
            if (value.HasValue)
            {
                ...
                return Encoding.UTF8.GetString(value).ToObject<TEntity>();
            }
            else
            {
        ...
        public void Set(string key, object value, TimeSpan cacheTime)
        {
            if (value != null)
            {
                ...
                redisConnection.GetDatabase().StringSet(key, Encoding.UTF8.GetBytes(value.ToJson()), cacheTime);
            }
        }
